...
const API = {
    ...
    sources: {
        ...
        backup: () => API.request('GET', '/sources/backup'),
        restore: (data, mode = 'merge') => API.request('POST', '/sources/restore', { sources: data, mode }),
    },
    ...
    settings: {
        ...
        getWarpLogs: () => API.request('GET', '/settings/warp-logs')
    },
